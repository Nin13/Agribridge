...
<body>
     ...
     <div class="header">
          ...
          <a href="Homepage.php"><img id="logo" src="agrilogo.jpg"></a>
     ...
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.Agribridge.com</h5>
     </div>
