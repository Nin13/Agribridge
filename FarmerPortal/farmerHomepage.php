 ...
 <body>
      ...
      <body>
           ...
           <div class="features container">
                <h1 style="font-weight: bold;color:black; text-align:center">Agribridge Features</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">Post Products </h4>
                               <br>
                               <h5 class="card-text">Upload and Edit Your Products </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               ...
                               <br>
                               <h5 class="card-text">Get in direct touch with the buyer to satisfy the farmer's need </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">Market</h4>
                               <br>
                               <h5 class="card-text">Farmers can now post their own products to the market. It raises fair competition between the farms.</h5>
                          </div>
                     </div>
                </div>
           </div>
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u><a href="https://www.agribridge.com/">Agribridge Corporation</a></u> is a Multitrading Company for farmers and market</p>
