...
<body>
     ...
     <body>
          ...
          <nav class="navbar navbar-expand-xl ">
               ...
               <div class=" flex-row-reverse left ">
                    ...
                    <a class="float-left" href="#">
                         <img src="agrilogo.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
                    </a>
               </div>
               ...
               <a class="float-left" href="farmerHomepage.php">
                    <img src="agrilogo.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
               </a>
          ...
          <div class="card">
               ...
               <div class="card-body">
                    <h5 class="card-title text-center font-weight-bold">Call Center Numbers can be displayed here/ For now features are displayed</h5>
                    <div class="card-deck">
                         <div class="card">

                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">Insert Product</h5>
                                   <p class="card-text">Farmers can insert their product. The products they created are displayed in buyer's dashboard.</p>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">Buyer Dashboard</h5>
                                   <p class="card-text">In buyer dashboard, all products posted by the farmers are displayed. They can add it to cart and buy the product.</p>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">Add to Cart</h5>
                                   <p class="card-text">After adding the products to cart. They can change the quantity the buyers want to buy.</p>
                                   <p></p>
                                   <p></p>
                              </div>
                         </div>
          ...
          <div style="display:block;">
               ...
               <br>
               <h4 align="center">Call Number : 09183951737</h4>
               <br>
               <table class="table">
                    ...
                    <tr align="center" class=trow>
                         ...
                         <th align="center">Luzon</th>
                         <th align="center">Manila</th>
                         <th align="center">Filipino/English</th>

                    </tr>
                    <tr align="center" class=trow>
                         <th align="center">2</th>
                         <th align="center">Visayas</th>
                         <th align="center">Cebu</th>
                         <th align="center">Filipino/English</th>
                    ...
                    <tr align="center" class=trow>
                         ...
                         <th align="center">Mindanao</th>
                         <th align="center">Davao</th>
                         <th align="center">Filipino/English</th>
                    </tr>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="https://www.agribridge.com/">Agribridge Corporation</a></u> is a Multitrading Company for farmers and markets</p>
                              <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Agritech</a></p>
                         </div>
                         </hr>
                    </div>
               </div>
