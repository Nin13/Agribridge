...
<head>
     ...
     <title>Agribridge Homepage</title>
...
<body>
          ...
          if ($run_pro) {
               ...
               while ($rows = mysqli_fetch_array($run_pro)) {
                    ...
                    echo " <div class='inputwrapper'>
                                                  ...
                                                  <label>PRICE:- $product_price Php/kg</label><br>	
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Agribridge</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">Agribridge6@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.Agribridge.com</h5>
     </div>
